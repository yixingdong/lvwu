...
<head>
    ...
    <style>
        *{margin:0; padding:0;}
        html{background:url('images/wali.jpg') no-repeat center center;
            min-height:100%;
...
<div style="position: absolute;top:30%;left:30%;width:500px;height: 100px;font-size: 50px;color: #b2dba1;font-family: Arial">Building....</div>
